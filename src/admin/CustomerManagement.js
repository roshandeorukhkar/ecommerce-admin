                ...
                <div id="wrapper">
                    <div className="page-wrapper">
                        <div className="container-fluid">
                                <h2 className="font-bold"> Customer
                                ...
                                <button className='btn btn-info' aria-label='Delete' title="Delet" style={{float: 'right', height:'42px'}}><i className='fa fa-search font-15'></i></button>
